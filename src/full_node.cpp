...
full_node::full_node(const configuration& configuration)
  : p2p_network(configuration.network),
    top_hash_(null_hash),
...
bool full_node::stop()
{
    ...
    const auto p2p_stop = p2p_network::stop();
...
bool full_node::close()
{
    ...
    const auto p2p_close = p2p_network::close();
...
hash_digest full_node::top_hash() const
{
