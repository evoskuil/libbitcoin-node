...
public:
    ...
    struct embedded_pages
    {
        ...
        virtual system::data_slice css() const NOEXCEPT { return {}; }
        virtual system::data_slice html() const NOEXCEPT { return {}; }
        virtual system::data_slice ecma() const NOEXCEPT { return {}; }
        virtual system::data_slice font() const NOEXCEPT { return {}; }
        virtual system::data_slice icon() const NOEXCEPT { return {}; }

        /// At least the html page is required to load embedded site.
        virtual bool enabled() const NOEXCEPT { return !html().empty(); }
    };
